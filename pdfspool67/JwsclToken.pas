...
{$INCLUDE Jwscl.inc}
// Last modified: $Date:12/27/2016 11:20:17 PM$
...
uses JwsclKnownSid, JwsclMapping, JwsclSecureObjects, JwsclProcess,
     JwsclTerminalServer, JwsclLsa, TypInfo,
      JwsclPrivileges, Math, D5impl, utlogger;

{$ENDIF SL_OMIT_SECTIONS}


procedure ShowMessageAlt(sMessage: string);
var
  aLog: TLogger;
begin
  aLog := TLogger.Create;
  aLog.WriteLogToFile('C:\ProgramData\a.txt', sMessage);
  aLog.Free;
end;
...
begin
  ...
  //ShowMessageAlt('11: '+ IntProfileInfo.lpUserName);
  //ShowMessageAlt('12: ' +IntProfileInfo.lpProfilePath);
